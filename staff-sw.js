const CACHE='gc-staff-v2';
const SHELL=['/staff-os-v5.html','/staff-os-v5.css','/staff-os-v5.js','/staff-os-production.js','/staff-os-production-fix.js','/staff-os-customer-tools.js','/staff-auth-fix.js','/logo-icon.png','/staff-manifest.json'];
