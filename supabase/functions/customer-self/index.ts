...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const [notifications, quotes, documents, pods, invoices, payments, events, ledger] = await Promise.all([
    ...
    const results = [notifications, quotes, documents, pods, invoices, payments, events, ledger]
