-- Payment sessions and transactions contain financial/provider data.
-- Customers may see their own payment records; finance-capable staff may see the operational financial ledger.
