-- Audit history and delivery evidence are append-only from authenticated clients.
-- Server-side control-plane functions continue to use service_role for controlled updates.
