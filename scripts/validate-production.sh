...
check "service worker contains control-plane, customer, payment and tracking assets" bash -c 'grep -q "control-plane.html" sw.js && grep -q "control-plane.js" sw.js && grep -q "customer-portal.html" sw.js && grep -q "payment-checkout.html" sw.js && grep -q "payment-checkout.js" sw.js && grep -q "tracking-route-controller.js?v=20260826-2" sw.js && grep -q "gc-v72" sw.js'
